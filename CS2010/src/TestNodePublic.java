...
/* Create a binary tree from scratch using the methods in the Node class
 * */
public class TestNodePublic {
    public static void main(String[] args) throws IOException {
        /* create 3 nodes that each contains its test data */
        Node<String> operator = new Node<String>("+", null, null); /* for testing purpose, redundant */
        ...
        /* test getLeft, getRight, setLeft, setRight methods by adding the operands to the operator */
        ...
        /* change the root data for demonstration purpose */
