...
/**
 * A week_10.MatrixGraph is an implementation of the week_10.Graph
...
public class MatrixGraph extends AbstractGraph {
     ...
     * edge does not exist, an week_10.Edge with a weight
    ...
    /**
     * An iterator to the edges.  An week_10.Edge iterator is
    ...
    private class Iter implements Iterator<Edge> {
         ...
         *
         * @return the next week_10.Edge in the iteration
