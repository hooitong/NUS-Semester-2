...
public class BinarySearchTree<E extends Comparable<E>>
    ...
    private Node<E> delete(Node<E> localRoot, E item) {
        ...
        if (compResult < 0) {
            ...
            if (localRoot.left == null) {
                ...
                // week_5.week_6.Node being deleted has 2 children, replace the data
     ...
     * toString method of the week_4.week_5.week_6.BinaryTree class would be hidden and it is
